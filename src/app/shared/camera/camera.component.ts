...
export class CameraComponent implements OnInit {
  ...
  base64Image: string = 'assets/img/box.jpg';
  photo: string = 'false';
  ...
  savePicture = () => 
    this.modal.dismiss({ result: this.base64Image });
}
